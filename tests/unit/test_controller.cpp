...
// These tests map clicks against a board drawn at the frame origin, so a pixel
// is a plain multiple of the cell size.
constexpr int cellSize = 100;

// Pixel at the centre of a cell (row, col).
int centre(int index) { return index * cellSize + cellSize / 2; }
